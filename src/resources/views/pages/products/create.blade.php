        ...
        <div class="card-body">
          ...
          <form method="POST"
            ...
            <div class="mb-3">
                ...
                <input type="color" name="color" class="form-control form-control-color" value="{{ old('color', '#000000') }}" title="{{ __('messages.choose_color') }}" />
                @error('color')
                <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
            <div class="mb-3">
                ...
                <textarea name="description" class="form-control" rows="5" placeholder="{{ __('messages.description') }}">{{ old('description') }}</textarea>
                @error('description')
                <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
